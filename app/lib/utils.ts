...
export function buildQuotedReplyBlock(
	...
	return `<br><blockquote style="border-left: 2px solid #ccc; margin: 0; padding-left: 1em; color: #666;">在 ${formattedDate}，${escapedSender} 写道：<br><br>${bodyToQuote}</blockquote>`;
}
