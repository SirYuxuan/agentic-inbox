...
export default function SearchResultsRoute() {
	...
	const folderDisplayName = (name: string | null | undefined): string => { if (!name) return ""; const map: Record<string, string> = { inbox: "收件箱", sent: "已发送", draft: "草稿箱", archive: "归档", trash: "废纸篓" }; return map[name.toLowerCase()] || name; };
